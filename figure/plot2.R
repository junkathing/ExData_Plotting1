...
data <- read.table(pipe('grep "^[1-2]/2/2007" "household_power_consumption.txt"'), na.strings="?", header=TRUE, col.names=c("Date", "Time", "Global_active_power", "Global_reactive_power", "Voltage", "Global_intensity", "Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), sep = ";", colClasses=c("character", "character", "numeric", "NULL" , "NULL", "NULL", "NULL", "NULL", "NULL"))
...
# This line opens a png graphics device with a file name of plot2.png
png(file="plot2.png")

#the next five lines make the plot, titles, and axes
...
mtext("Global Active Power (kilowatts)", side = 2, line =2 , outer = FALSE,cex =1)
